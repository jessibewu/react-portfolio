...
return(
<section class="mb-5">
    <h1 className="resume">resume: Jessica Wu</h1>
        <hr></hr>
        <div class="row justify-content-center" id="resume">
            <div class="mt-5 pl-5 pr-5">
                Full stack developer with experience the MERN stack. Experienced in product management and software development. 
